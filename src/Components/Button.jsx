const Button = ({ className = "", type = "default", children, onClick }) => {
  const variants = {
  ...
  const baseStyle =
    "w-40 h-10 content-center text-center rounded-lg shadow-md/50 ring-2 active:scale-90 hover:scale-110 transition-transform cursor-pointer";
